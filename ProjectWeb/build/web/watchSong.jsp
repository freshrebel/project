    ...
    <form method="POST" action="watchSong">
        <table>
            <tr>
                ...
                <td>
                    <input type="text" name="titel" id="titel" value="<%=nummer.getTitel()%>" disabled/>
                    <input type="hidden" name="id" id="id" value="<%=nummer.getId()%>"/>
                </td>
            </tr>
            <tr>
                <td><label for="artiest">artiest:</label></td>
                <td><input type="text" name="artiest" id="artiest" value="<%=nummer.getArtiest()%>" disabled /></td>
            </tr>
            <tr>
                <td><label>tijd:</label></td>
                <td>
                    <input type="number" name="minuten" id="minuten" style="width:3em;" value="<%=nummer.getMinuten()%>" disabled/>min
                    <input type="number" name="seconden" id="seconden" style="width:3em;" value="<%=nummer.getSeconden()%>" disabled/>sec
                </td>
            </tr>
            <tr>
                <td><label for="bpm">bpm:</label></td>
                <td><input type="number" name="bpm" id="bpm" value="<%=nummer.getBpm()%>" disabled/></td>
            </tr>
            <tr>
                <td><label for="genres">genres:</label></td>
                <td><input type="text" name="genres" id="genres" value="<%=nummer.getGenres()%>" disabled/></td>
            </tr>
            <tr>
                <td><label for="labels">labels:</label></td>
                <td><input type="text" name="labels" id="labels" value="<%=nummer.getLabels()%>" disabled/></td>
            </tr>
            <tr>
